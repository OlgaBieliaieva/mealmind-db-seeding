...
class RecipeRepository {
    ...
    async createNutrients(recipeId, nutrients) {
        if (!nutrients.length)
            return;
    ...
    async replaceNutrients(recipeId, nutrients) {
    ...
    async replaceCuisines(recipeId, cuisineIds) {
    ...
    async replaceDietaryTags(recipeId, tagIds) {
