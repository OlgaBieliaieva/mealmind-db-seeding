...
const product_admin_service_1 = require("./application/product.admin.service");
const product_client_service_1 = require("./application/product.client.service");
...
function createProductModule(prisma) {
    ...
    const adminService = new product_admin_service_1.ProductAdminService(repo, searchQuery, validationQuery);
    const clientService = new product_client_service_1.ProductClientService(repo, searchQuery);
    const adminController = new product_admin_controller_1.ProductAdminController(adminService);
    const clientController = new product_client_controller_1.ProductClientController(clientService);
