...
exports.presentRecipeListItem = presentRecipeListItem;
function presentRecipeListItem(recipe) {
    const energy = recipe.nutrients.find((n) => n.nutrient.code === "energy_kcal");
    // 👉 вага рецепта (база)
